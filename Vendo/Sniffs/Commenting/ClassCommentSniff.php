...
if (class_exists('Vendo_Sniffs_Commenting_FileCommentSniff', true) === false) {
    $error = 'class Vendo_Sniffs_Commenting_FileCommentSniff not found';
    throw new PHP_CodeSniffer_Exception($error);
}
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Vendo_Sniffs_Commenting_ClassCommentSniff extends Vendo_Sniffs_Commenting_FileCommentSniff
{
